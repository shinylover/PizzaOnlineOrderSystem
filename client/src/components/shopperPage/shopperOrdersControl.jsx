...
import { Drawer, Button, Col, Row, InputNumber, Collapse, Slider, Space, Divider, Radio, Input } from 'antd';
...
export default class ShopperOrdersControl extends Component {
    ...
    getBookings = ()=>{
        ShopperApi.getBookings(this.props.order.oid)
            .then((bookings) => {
                this.setState({
                    bookings: bookings
                }, ()=>{
    ...
    changeStates = () => {
        ShopperApi.changeStates(this.props.order.oid, this.state.value)
            .then((response) => {
                // TODO: delete
            ...
            //     <Fragment>
                    // {(context)=>
                        ...
                        <Button type="primary" onClick={this.showDrawer}
                         ...
                         >
                            {order.states===0? "Confirm" : order.states===1 ? "Delivering" :  order.states===2 ? "Editing": "Details"}
                        </Button>
                        <Drawer
                        ...
                        footer={
                            ...
                            >    
                                <Space >
                                    ...
                                    <Button onClick={this.changeStates} type="primary">
                                        changeStates
                                    </Button>
                                </Space>
                            </div>
                        ...
                        <Collapse defaultActiveKey={['1']} onChange={this.callback}>
                            ...
                            <Panel header="Set the states" key="4">
                                <Row gutter={16}>
                                    <Col  span={24}>
                                    Chose 6 toppings:
                                    </Col>
                                    ...
                                    <Col span={12}>
                                        <Radio.Group onChange={this.onChangeRadio} value={value}>
                                            ...
                                            Set this order as Making 
                                            </Radio>
                                            <Radio style={radioStyle} value={1}>
                                            Accept this order, Set this order as Waiting for collecting 
                                            </Radio>
                                            <Radio style={radioStyle} value={2}>
                                            Let client to edit this order
                                            </Radio>
                                            <Radio style={radioStyle} value={3}>
                                            Set this order as finished
                                            </Radio>
                                        </Radio.Group>
                                    </Col>
                                </Row>
